      ...
      <main className="flex-1 overflow-y-auto p-8">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-foreground/90">RAG 智能问答</h2>
          </div>
            ...
            <div className="backdrop-blur-xl bg-card/40 border border-border/50 rounded-2xl p-6 shadow-xl">
              ...
              <form onSubmit={handleAsk}>
                <div className="relative">
                  <Input
                    type="text"
                    placeholder="请输入您的问题，例如：这张图的属于哪一类型图？研究对象是什么？"
                    value={question}
                    onChange={(e) => setQuestion(e.target.value)}
                    disabled={isLoading || isUploading}
                    className="h-14 pl-12 pr-32 text-[15px] backdrop-blur-xl bg-transparent border-border/60 rounded-2xl shadow-lg focus-visible:ring-2 focus-visible:ring-primary/30 text-foreground font-semibold placeholder:text-gray-400 placeholder:font-normal"
                  />
                  ...
                  <div className="absolute right-2 top-1/2 -translate-y-1/2">
                    <Button
                      ...
                      className="h-10 px-6 text-[14px] text-foreground bg-gradient-to-r from-pink-500 to-blue-500 hover:from-primary/90 hover:to-purple-500/90 shadow-lg shadow-primary/20"
                    >
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                <span className="text-[13px] text-gray-500">试试这些问题：</span>
                {[
                  "这张图分了哪几类？",
                  "对象的主要聚集区在哪？",
                  "主要的研究区域是哪里？",
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="h-7 text-[11px] border-border/60 text-gray-600 hover:border-primary/40 hover:bg-primary/10 hover:text-foreground"
              ...
              <div className="text-center py-8">
                ...
                <h3 className="text-[16px] font-bold text-black text-foreground mb-2">
                  支持文本、PDF、图像混合检索
                </h3>
                <p className="text-[13px] text-gray-400 max-w-md mx-auto">
                  可直接输入图像、PDF、文档等文件，系统将使用多模态大模型进行语义识别与检索
                </p>
              </div>
            </div>
          )}
              ...
              >
                <div className="flex items-start gap-2 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h5 className="text-[13px] font-medium text-foreground mb-2">
                      {source.file_name}
                    </h5>
                    <div className="flex items-center gap-2 flex-wrap">
                      <Badge variant="outline" className="text-[10px] px-2 py-0.5 border-border/50 !text-red-800">
                        {source.file_type}
                      </Badge>
                      <Badge
                        variant="default"
